...
local build_mss_bin = '/home/nicholasmabe/framery_repos/deps/radar/ccs1200/ccs/eclipse/eclipse -noSplash -data /home/nicholasmabe/framery_repos/deps/workspaces/CodeComposerWorkspace/ -application com.ti.ccstudio.apps.projectBuild -ccs.autoImport -ccs.projects framery_radar_unit_mss -ccs.configuration Release | grep --color=always -e "^" -e "error"'
local build_bss_bin = '/home/nicholasmabe/framery_repos/deps/radar/ccs1200/ccs/eclipse/eclipse -noSplash -data /home/nicholasmabe/framery_repos/deps/workspaces/CodeComposerWorkspace/ -application com.ti.ccstudio.apps.projectBuild -ccs.autoImport -ccs.projects framery_radar_unit_bss -ccs.configuration Release | grep --color=always -e "^" -e "error"'
...
local zip_files = 'rm supra*.zip; ' .. no_bin_name .. ' | xargs -I {} zip -r {} ' .. release_bin_path .. '{}.bin'
...
local clean_mss_files = '/home/nicholasmabe/framery_repos/deps/radar/ccs1200/ccs/eclipse/eclipse -noSplash -data /home/nicholasmabe/framery_repos/deps/workspaces/CodeComposerWorkspace/ -application com.ti.ccstudio.apps.projectBuild -ccs.autoImport -ccs.projects framery_radar_unit_mss -ccs.clean | grep --color=always -e "^" -e "error"'
local clean_bss_files = '/home/nicholasmabe/framery_repos/deps/radar/ccs1200/ccs/eclipse/eclipse -noSplash -data /home/nicholasmabe/framery_repos/deps/workspaces/CodeComposerWorkspace/ -application com.ti.ccstudio.apps.projectBuild -ccs.autoImport -ccs.projects framery_radar_unit_mss -ccs.clean | grep --color=always -e "^" -e "error"'
local clean_files = clean_mss_files .. nextop .. clean_bss_files
...
local commands = {
  ["3"] = {
    ["2"] = {
      [cmd]= clear .. build_mss_bin,
      [desc]='Build the ' .. bin_name .. '',
      [name]=build,
    },
    ["1"]={
      [cmd]='clear; ' .. stop_main_service .. ands .. clean_fw_bin .. ands .. inc_version .. build_mss_bin .. ands .. clean_device_bin .. ands .. rename_bin .. ands .. push_files .. ands .. start_main_service .. ands .. zip_files,
